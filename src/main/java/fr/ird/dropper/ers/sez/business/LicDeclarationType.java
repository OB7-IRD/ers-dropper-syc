...
public class LicDeclarationType {

    @XmlElement(name = "IDN", required = true)
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    protected IdnDeclarationType idn;
    @XmlElement(name = "ZON")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    protected List<ZonDeclarationType> zon;
    @XmlElement(name = "SPE")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    protected List<SpeLicDeclarationType> spe;
    @XmlElement(name = "GEA")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
     ...
     *
     * @return possible object is {@link IdnDeclarationType }
     *
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    public IdnDeclarationType getIDN() {
        return idn;
    }
     ...
     *
     * @param value allowed object is {@link IdnDeclarationType }
     *
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    public void setIDN(IdnDeclarationType value) {
        this.idn = value;
    }
     ...
     * {@link ZonDeclarationType }
     *
     *
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    public List<ZonDeclarationType> getZON() {
        if (zon == null) {
            zon = new ArrayList<ZonDeclarationType>();
        }
        return this.zon;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SpeLicDeclarationType }
     *
     *
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    public List<SpeLicDeclarationType> getSPE() {
        if (spe == null) {
            spe = new ArrayList<SpeLicDeclarationType>();
        }
        return this.spe;
    }
