 ...
 *
 * <p>
 * Classe Java pour RtpDeclarationType complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="RtpDeclarationType"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="DS" type="{http://www.w3.org/2001/XMLSchema}int" /&gt;
 *       &lt;attribute name="SD" type="{http://www.w3.org/2001/XMLSchema}int" /&gt;
 *       &lt;attribute name="FD" type="{http://www.w3.org/2001/XMLSchema}int" /&gt;
...
public class RtpDeclarationType extends EvenementDePecheImpl {
    ...
    /**
     * Obtient la valeur de la propriété tv.
     *
     * @return possible object is {@link String }
     *
     */
    ...
    /**
     * Définit la valeur de la propriété tv.
     *
     * @param value allowed object is {@link String }
     *
     */
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    public void setDS(Integer value) {
        this.ds = value;
    }
    ...
    public void addToLog(LogDeclarationType log) {
        if (log.getRTP() == null) {
            log.setRTP(new ArrayList<RtpDeclarationType>());
        }
        log.getRTP().add(this);
    }
