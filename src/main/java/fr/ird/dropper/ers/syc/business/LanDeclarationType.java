 ...
 *
 * <p>
 * Classe Java pour LanDeclarationType complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="LanDeclarationType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="TRN" type="{http://ec.europa.eu/fisheries/schema/ers/v3}TrnDeclarationType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 ...
 *       &lt;attribute name="TS" type="{http://ec.europa.eu/fisheries/schema/ers/v3}SenderType" /&gt;
 *       &lt;attribute name="AG" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
...
public class LanDeclarationType extends EvenementDePecheImpl {
    ...
    @XmlElement(name = "TRN")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    protected List<TrnDeclarationType> trn;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TrnDeclarationType }
     *
     *
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2019-07-04T06:18:33+04:00", comments = "JAXB RI v2.3.0")
    public List<TrnDeclarationType> getTRN() {
        if (trn == null) {
            trn = new ArrayList<TrnDeclarationType>();
        }
        return this.trn;
    }
    ...
    /**
     * Obtient la valeur de la propriété ag.
     *
     * @return possible object is {@link String }
     *
     */
    ...
    /**
     * Définit la valeur de la propriété ag.
     *
     * @param value allowed object is {@link String }
     *
     */
    ...
    public void addToLog(LogDeclarationType log) {
        if (log.getLAN() == null) {
            log.setLAN(new ArrayList<LanDeclarationType>());
        }
        log.getLAN().add(this);
    }
